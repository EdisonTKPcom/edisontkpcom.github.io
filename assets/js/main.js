...
/* REMOVE MENU MOBILE (selector names aligned with HTML: nav_link/nav_menu) */
...
function scrollActive() {
    ...
    sections.forEach(current => {
        ...
        if (!link) return; // guard if link not present
...
/* SHOW SCROLL TOP (id aligned with HTML: scrolltop) */
